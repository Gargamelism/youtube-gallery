  ...
  return (
    <div className="SettingsPage max-w-4xl mx-auto px-4 py-8">
      <div className="SettingsPage__header mb-8">
        <h1 className="SettingsPage__title text-3xl font-bold text-gray-900 mb-2">{t('settings:title')}</h1>
        <p className="SettingsPage__subtitle text-gray-600">{t('settings:subtitle')}</p>
      </div>
