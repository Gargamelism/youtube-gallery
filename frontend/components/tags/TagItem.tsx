    ...
    <div className="TagItem flex items-center justify-between p-3 border rounded-lg hover:bg-gray-50">
      <div className="flex items-center gap-3 flex-1">
        ...
        <div className="flex-1">
          <div className="text-sm text-gray-500">{t('tagUsageCount', { count: tag.channel_count })}</div>
          {tag.description && <div className="text-xs text-gray-400 mt-1">{tag.description}</div>}
        </div>
      </div>
