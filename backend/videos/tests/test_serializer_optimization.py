...
class VideoSerializerOptimizationTests(TestCase):
    ...
    def test_serializer_uses_prefetched_data(self):
        ...
        self.assertLess(query_count, 5, 
                       f"Too many queries ({query_count}) during serialization. "
                       f"Expected <5 with proper prefetching.")
    ...
    def test_serializer_without_optimization(self):
        ...
        self.assertGreater(query_count, 5, 
                          f"Expected many queries ({query_count}) without prefetching optimization")
    ...
    def test_search_service_query_efficiency(self):
        ...
        results = list(search_service.search_videos(
            tag_names=["Tech"],
            tag_mode="any",
            watch_status="all"
        ))
        ...
        self.assertLess(query_count, 10, 
                       f"Search service used {query_count} queries, expected <10")
