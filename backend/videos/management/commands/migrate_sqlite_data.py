...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if not os.path.exists(sqlite_db_path):
            self.stdout.write(
                self.style.ERROR(f'SQLite database not found: {sqlite_db_path}')
            )
            return
    ...
    def migrate_videos(self, cursor):
        ...
        for row in videos_data:
            ...
            # privacy_status, upload_status, tags, thumbnail_path, video_url, is_watched, created_at, updated_at
            ...
            video, created = Video.objects.get_or_create(
                ...
                defaults={
                    ...
                    'privacy_status': row[12] or '',  # privacy_status
